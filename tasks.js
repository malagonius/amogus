const tasks = [
  ...
  { category: "Religiose", icon: "🗣️", text: "Lezione lampo: parla per 30 secondi sulla FEDE." },
  { category: "Religiose", icon: "🗣️", text: "Lezione lampo: parla per 30 secondi sul PENTIMENTO." },
  { category: "Religiose", icon: "🗣️", text: "Lezione lampo: parla per 30 secondi sul BATTESIMO." },
  { category: "Religiose", icon: "🗣️", text: "Lezione lampo: parla per 30 secondi sullo SPIRITO SANTO." },
  { category: "Religiose", icon: "🗣️", text: "Lezione lampo: parla per 30 secondi sulla PERSEVERANZA." },
